<template>
  ...
  <nut-tabbar unactive-color="#364636" active-color="#1989fa" @tab-switch="tabSwitch">
    ...
    <nut-tabbar-item :tab-title="'tabbar.tab1'" font-class-name="iconfont" class-prefix="icon" icon="list" />
    <nut-tabbar-item :tab-title="$t('tabbar.me')" font-class-name="iconfont" class-prefix="icon" icon="member" />
  </nut-tabbar>
</template>
